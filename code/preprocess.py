...
def retrieve_data_ocr(test_split, data_path):
    """
...
def split_it_up_ocr():
    save_folder = "./../split_processed_whole_data/"
    X_train, X_test, X_val, Y_train, Y_test, Y_val = get_data_ocr(0.3, "./../processed_whole_data/")
